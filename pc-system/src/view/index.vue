        ...
        <Layout>
            <Sider ref="side1" hide-trigger collapsible :collapsed-width="78" v-model="isCollapsed" style="background: rgb(73, 80, 96);">
                <div class="logo" >
                    ...
                    <Avatar icon="person" :src="logo" size="large" v-else/>
                </div>
                <Menu 
                    ref="side_menu"
                ...
                <div class="dropdown-wrap">
                    <template v-for="(menu,menu_index) in menus" v-if="isCollapsed">
                        ...
                        <Dropdown transfer v-if="!menu.children && menu.showInMenus" placement="right-start" @on-click="dropdownClick" :key="menu_index">
                            <Button style="width: 83px;margin-left: -5px;padding:10px 0;" type="text">
                                <Icon :size="25" color="#fff" :type="menu.icon"></Icon>
                            </Button>
                            <DropdownMenu style="width: 200px;" slot="list">
                ...
                <Header :style="{position: 'fixed',
                    ...
                    <div style="display: flex;
                        ...
                        <template v-for="(tab,tab_index) in tags">
                            ...
                            @on-close="closeTag" :key="tab_index" >
                                {{tab.title}}
                            </Tag>
                        </template>
                    </div>                  
...
<style>
    ...
    .dropdown-wrap .ivu-btn-text:hover{
...
export default {
    data(){
        return{
            logo:"https://ss3.baidu.com/-rVXeDTa2gU2pMbgoY3K/it/u=100123053,4053951189&fm=202&mola=new&crop=v1",
            isCollapsed: false,
            // ------------------------------  菜单操作开始  --------------------------------
            title:'首页',
            activeMenuName:'home',
